...
class MinkSingleStage3DDetector(Base3DDetector):
    ...
    def extract_feat(self, points):
        ...
        # from mmdet3d.models.backbones.mink_resnet import MinkResNet
        # import torch
        # # model = MinkResNet(in_channels=3, depth=34)
        # # with SummaryWriter(comment='vis') as w:
        # #     w.add_graph(model, (x,)) #可视化失败，不支持稀疏Tensor
        # model = MinkResNet(in_channels=3, depth=34)
        # print("MinkResNet=",model)
        # torch.save(model, "modelviz.pt")
