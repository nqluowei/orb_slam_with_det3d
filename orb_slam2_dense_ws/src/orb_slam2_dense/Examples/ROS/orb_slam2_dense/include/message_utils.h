...
namespace ORB_SLAM2_DENSE
{
    ...
    public:
        ...
        void publishOdometry(cv::Mat matTcw);

        void publishFrame();

        bool publishPointCloud(const sensor_msgs::ImageConstPtr& msgRGB);
    ...
    protected:
        ...
        tf::Transform TransformFromMat (cv::Mat position_mat,bool need_rotate);
